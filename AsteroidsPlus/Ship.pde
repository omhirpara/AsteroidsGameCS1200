...
class Ship extends GameObject
{
  ...
  int shieldTime;
  int rapidfireTime; /////////////////////////////////////////////////////////////////////added
  boolean rapidfireOn; /////////////////////////////////////////////////////////////////////added
  boolean isShielded;
  
  StopWatch shieldSW;
  StopWatch rapidfireSW; /////////////////////////////////////////////////////////////////////added
  

  Ship(PApplet game, int xpos, int ypos) 
  {
    this(game, "MyShip.jpg", xpos, ypos);
    setScale(.8);
  }
  ...
  Ship(PApplet game, String imageFilename, int xpos, int ypos) 
  {
    ...
    rapidfireOn = false; /////////////////////////////////////////////////////////////////////added
    rapidfireSW = new StopWatch(); /////////////////////////////////////////////////////////////////////added
  ...
  void update() 
  {
    ...
    if (rapidfireSW.getRunTime() > rapidfireTime) { /////////////////////////////////////////////////////////////////////added
      rapidfireOn = false;
    }
  }
  ...
  void setRapidfire(int time) /////////////////////////////////////////////////////////////////////added
  {
    rapidfireOn = true;
    rapidfireTime = time;
    rapidfireSW.reset();
